      subroutine fourt (data,n,ndim,isign,iform,work,nwork)             fft   1
...
c     are done by goertzel's algorithm (4).                             coo  12
      ...
      twopi=6.28318530718*dble(isign)                                   coo  14
      ip0=2                                                             coo  15
 ...
 60   ip3=ip2*ifcur                                                     coo  29
      theta=twopi/ dble(ifcur)                                          coo  30
      sinth=dsin(theta/2.)                                               coo  31
      rootr=-2.*sinth*sinth                                             coo  32
c     cos(theta)-1, for accuracy.                                       coo  33
      rooti=dsin(theta)                                                  coo  34
      theta=twopi/ dble(ip3/ip1)                                        coo  35
      sinth=dsin(theta/2.)                                               coo  36
      wstpr=-2.*sinth*sinth                                             coo  37
      wstpi=dsin(theta)                                                  coo  38
      wr=1.                                                             coo  39
      wi=0.                                                             coo  40
...
c     a simple conjugation of data(i1,i2).                              fix  22
      ...
      twopi=6.28318530718*dble(isign)                                   fix  24
      ip0=2                                                             fix  25
      ip1=ip0*(n/2)                                                     fix  26
      ip2=ip1*nrem                                                      fix  27
...
c     pack the real input values (two per column)                       fix  29
 ...
 90   theta=twopi/ dble(n)                                              fix  52
      sinth=dsin(theta/2.)                                               fix  53
      zstpr=-2.*sinth*sinth                                             fix  54
      zstpi=dsin(theta)                                                  fix  55
      zr=(1.-zstpi)/2.                                                  fix  56
      zi=(1.+zstpr)/2.                                                  fix  57
